package com.kagenyx.cursomods.util;
...
public class ModTags {
    public static class Blocks {
        ...
        private static Tags.IOptionalNamedTag<Block> tag(String name) {
            return BlockTags.createOptional(new ResourceLocation(CursoMods.EXAMPLEMOD, name));
        }
    ...
    public static class Items {
        ...
        private static Tags.IOptionalNamedTag<Item> tag(String name) {
            return ItemTags.createOptional(new ResourceLocation(CursoMods.EXAMPLEMOD, name));
        }
